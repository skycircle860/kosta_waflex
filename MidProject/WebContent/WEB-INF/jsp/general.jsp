        ...
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="showback">
              ...
              <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal" onclick="test()">
                Launch Modal
                </button>
              <!-- Modal -->
              <form method="post" action="testc" enctype="multipart/form-data" id="tform">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                    	<input type="text" id="test" name="test" id="test">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-primary" onclick="testaction()">Save changes</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!--  GRITTER NOTICES -->
            <div class="showback">
              <h4><i class="fa fa-angle-left"></i> Gritter Examples</h4>
              ...
              <a id="add-without-image" class="btn btn-info  btn-sm" href="javascript:;">save info</a>
